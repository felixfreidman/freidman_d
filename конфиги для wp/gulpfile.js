...
gulp.task(
    "js",
    gulp.series("js:copy", "js:plugins", "js:components", function(done) {
        done();
    })
);
...
gulp.task(
    "images:watch",
    gulp.series("images:clean", function() {
...
gulp.task("webp", function() {
    return gulp
        .src(config.src.img, { base: config.src.imgBase })
        .pipe(buffer())
...
gulp.task(
    "fonts:watch",
    gulp.series("fonts:clean", function() {
