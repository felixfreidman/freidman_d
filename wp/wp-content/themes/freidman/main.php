...
<body class="page-home index-home">
    <div class="header-container--index">
        ...
        <div class="header-nav"> <a class="header-nav__link" href="http://dfreidman.hostfl.ru/about" target="_blank">Обо
                мне</a><a class="header-nav__link" href="http://dfreidman.hostfl.ru/projects"
                target="_blank">Проекты</a><a class="header-nav__link" href="http://dfreidman.hostfl.ru/contact"
    ...
    ?>
            ...
            </div><a class="watch-all-container" href="http://dfreidman.hostfl.ru/projects" target="_blank">Посмотреть
                все проекты </a>
        </div>
    </main>
    <?php get_footer()?>