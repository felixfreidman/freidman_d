...
<body class="page-home index-home">
    <div class="header-container--index">
        ...
        <div class="header-nav"> <a class="header-nav__link" href="http://polytest.hostfl.ru/about" target="_blank">Обо
                мне</a><a class="header-nav__link" href="http://polytest.hostfl.ru/projects"
                target="_blank">Проекты</a><a class="header-nav__link" href="http://polytest.hostfl.ru/contact"
    ...
    <main class="main main-home">
        <div class="main-container">
            ...
            </div><a class="watch-all-container" href="http://polytest.hostfl.ru/projects" target="_blank">Посмотреть
                все проекты </a>
        </div>
    </main>
    <?php get_footer()?>