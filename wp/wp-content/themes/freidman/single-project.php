...
<body class="page-home">
    ...
    <div class="header-list--mobile header-list--transform_top" id="mobile-list"><a class="header-nav__link"
            href="http://polytest.hostfl.ru/about" target="_blank">Обо мне</a><a class="header-nav__link" href="http://polytest.hostfl.ru/projects"
            target="_blank">Проекты</a><a class="header-nav__link" href="http://polytest.hostfl.ru/contact" target="_blank">Связаться </a>
    </div>
                ...
                <div class="project-image">
                    <div class="swiper project-swiper" id="project-swiper">
                        <div class="swiper-wrapper project-wrapper">
                            <div class="swiper-slide project-slide"><img
                                    src="<?php echo get_template_directory_uri() . '/assets/images/content/homeImage.png'?>"
                                    alt=""></div>
                            <div class="swiper-slide project-slide"><img
                                    src="<?php echo get_template_directory_uri() . '/assets/images/content/homeImage.png'?>"
                                    alt=""></div>
